    ...
    return (
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" sx={{ backgroundColor: '#222222' }}>
          <Toolbar>
            <img style={{ height: '60px', width: '200px' }} src="./logo.png" alt="Etrader" />
            ...
            <React.Fragment>
              <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                <Link href="/payment" underline="none">
                  <Typography sx={{ minWidth: 100, color: '#ffffff'  }}>Pay</Typography>
                </Link>
                <Link href="/tradingViewWidget" underline="none" >
                  <Typography sx={{ minWidth: 100, color: '#ffffff' }}>View</Typography>
                </Link>
                <Link href="/product" underline="none">
                  <Typography sx={{ minWidth: 100, color: '#ffffff' }}>Product</Typography>
                </Link>

                <Tooltip title="Account settings" underline="none">
                  <IconButton
                    onClick={handleClick}
                    size="small"
                    sx={{ ml: 2 }}
              ...
              >
                <Link href="/profile" underline="none">
                  <MenuItem onClick={handleClose}>
                    <Avatar /> <Typography sx={{ minWidth: 100, color: 'black' }}>Profile</Typography>
                  </MenuItem>
                </Link>
                {/* <Link href="/">
                  <MenuItem onClick={handleClose}>
                ...
                {isAdmin ? (
                  <Link href="/data"  underline="none">
                    <MenuItem onClick={handleClose}>
                      <Avatar /> <Typography sx={{ minWidth: 100, color: 'black' }}>Admin</Typography>
                    </MenuItem>
                  </Link>
                ) : null}
                <Divider />
